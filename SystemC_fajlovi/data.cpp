...
int list_white[16]; //dejan
int list_black[16]; //dejan
/* the board representation */
int color[64];  /* LIGHT, DARK, or EMPTY */
int piece[64];  /* PAWN, KNIGHT, BISHOP, ROOK, QUEEN, KING, or EMPTY */
int side;  /* the side(Dejan:Black or White) to move */
...
//Dejan: True for bishop, rock and queen because they can slide for more than 1 space
BOOL slide[6] = {
...
int offset[6][8] = {
	...
	{ -11, -9, 9, 11, 0, 0, 0, 0 },         //Bishop 1 slide
	{ -10, -1, 1, 10, 0, 0, 0, 0 },         //Rock 1 slide
	{ -11, -10, -9, -1, 1, 9, 10, 11 },     //Queen 1 slide
	{ -11, -10, -9, -1, 1, 9, 10, 11 }      //King 1 slide
};
